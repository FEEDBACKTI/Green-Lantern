...
if %errorlevel% equ 0 (
    echo Valor de MouseSpeed cambiado a 1 correctamente.
    ...
    echo Cambio de MouseSpeed a Valor 1 %DateTime% >> "C:\Users\psand\OneDrive\Documentos\doc\Reglas ASR\Activando\Resultados\resultado_log.txt"
) else (
    echo Error al cambiar el valor de MouseSpeed.
)
