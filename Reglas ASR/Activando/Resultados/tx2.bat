...
echo. >> %temp%\temp.reg
echo [HKEY_USERS\.DEFAULT\Control Panel\Mouse] set RegFile1=C:\Users\psand\OneDrive\Documentos\doc\Reglas ASR\Activando\Menu\1.reg>> %temp%\temp.reg
echo "rx2"="1" >> %temp%\temp.reg
...
if %errorlevel% equ 0 (
    echo Valor de 'rx2' cambio a 1 correctamente.
